<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Paid.aspx.vb" Inherits="Admin_Paid" %>
                ...
                <div class="container general">
                    <div id="content" class="single col-lg-12 col-md-12 col-sm-12">
                        ...
                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            CellPadding="0" border="0" class="display" ShowHeaderWhenEmpty="true">
                            <Columns>
